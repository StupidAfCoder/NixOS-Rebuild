...
[01..05]       All / Games / Create / Tools    [full-width contact sheet]
...
[09:41]        count / key hints

[utilities]    Quick wallpapers: ONLY floating images + outlined text
...
system. Their vertical center follows that origin, with frame-safe clamping. No origin is
...
| Wallpaper studio | Down from search enters contact sheet; arrows select/preview; Tab reaches palette/sliders/actions; Escape closes. |
| Quick wallpaper | Arrows or wheel browse; Enter/click applies; Escape/outside click closes. Drag selection is retained after release. |
